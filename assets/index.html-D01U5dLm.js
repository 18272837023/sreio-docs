import{_ as n,c as a,e,o as i}from"./app-_WtxHuRU.js";const l={};function p(r,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>服务提供器是所有 Laravel 应用程序引导中心。你的应用程序自定义的服务、第三方资源包提供的服务以及 Laravel 的所有核心服务都是通过服务提供器进行注册(register)和引导(boot)的。</p><p>拿一个Laravel框架自带的服务提供器来举例子</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>class BroadcastServiceProvider extends ServiceProvider</span></span>
